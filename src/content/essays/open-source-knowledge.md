...
But before the literary journals, and [bookstore economists](https://kwharrison13.com/portfolio-ideas) jump up and down, I'm not talking about the [decline in reading](https://news.gallup.com/poll/388541/americans-reading-fewer-books-past.aspx) or the [explosion of e-books](https://www.pewresearch.org/fact-tank/2022/01/06/three-in-ten-americans-now-read-e-books/).

**Books are dead from day one.** A few years ago I picked up a book called, [The Elements of Journalism](https://kwharrison13.com/bookshelf/2017-in-books). This was just after the 2016 election, and the popularization of "Fake News." After I got a few chapters in I realized the book was written in 2001, and I was shocked with how much of it was mostly irrelevant. The book was, effectively, dead.
...
[I've written before](https://investing1012dot0.substack.com/p/being-honest-about-intellectual-honesty) about a "spirit of humility" that investors ought to have. More people should be willing to change their minds. **More people should treat their ideas like software that is open source, and in active development.** Instead, people treat their ideas like a bridge; stable, but slowly decaying.

The idea of "open source knowledge" came from reading the book [Working in Public](https://www.amazon.com/Working-Public-Making-Maintenance-Software/dp/B08KWR85F8) by [Nadia Eghbal Asparouhova](https://twitter.com/nayafia). She masterfully covers the evolution of open source software, but so often she also drew parallels to other types of creative endeavors, like content, that I couldn't help but think about the implications for the knowledge we all have and share:
...
Open-source knowledge has become one of my biggest [portfolio ideas](https://kwharrison13.com/portfolio-ideas) where I collect it in tags, articles, and books. This week I [announced](https://twitter.com/kwharrison13/status/1570125846471659522?s=20&t=pU4hDDDDXaXnYU9K3PzxZw) a project that has let me think even more about this concept, so I thought I would (1) share that project with you, and the thinking behind it, and then (2) use that to illustrate what exactly I mean by "open-source knowledge."
...
Sharp people want to tackle hard problems, and often the solutions to those problems result in building a company. [Each company has a story](https://investing1012dot0.substack.com/p/the-storytelling-of-investing). And while the people are a critical part, there is also the technology, and the market, and the competitors.
...
1. The power of contributors
2. The feedback loop of a community
3. The interconnectivity of ideas
...
Ultimately, whether knowledge specialists (i.e. contributors) hold sway depends on how broadly they are listened to. That subjectivity makes widespread adoption more difficult, but not impossible. There have always been people dedicating their whole lives to esoteric fields, but the internet has made them much [more accessible](https://www.ghostknowledge.com/). The internet also made it easier for communities to form around these idea centers (or repos).

## Community Feedback Loops

There are already mechanisms for building communities around knowledge and ideas. Another one of my [portfolio ideas](https://kwharrison13.com/portfolio-ideas) fits in here: building cities. In the book, "[Walt Disney and the Promise of Progress City](https://www.amazon.com/Walt-Promise-Progress-City-Gennawey/dp/0615540244)," you see this insight:
...
Whether it’s cities, universities, research labs, [Juntos](https://en.wikipedia.org/wiki/Junto_(club)), or book clubs—people love to congregate around shared ideas and projects. Companies that are built on open-source software specifically point to the [power of their community](https://research.contrary.com/reports/grafana?head=;;business--;;model) as a competitive differentiation. That's because they understand the value of that feedback loop.
...
There are people who have been [held up](https://www.amazon.com/Walt-Promise-Progress-City-Gennawey/dp/0615540244) as examples of "idea alchemists," who can "synthesize the best of other people's ideas and create something not only better, but wholly unique." **The process of understanding complex fields is valuable, not only because you better understand those specific things, but because you better understand things**. Period.

[Packy McCormick](https://www.notboring.co/p/idea-legos) quotes [Tim Urban](https://waitbutwhy.com/2017/04/neuralink.html) while offering the best description on the power of compounding ideas:
...
[Mario Gabriele](https://twitter.com/mariogabriele) and [Packy McCormick](https://twitter.com/packyM) are the [bards](https://en.wikipedia.org/wiki/Bard) of company building and investing.

[Techcrunch](https://techcrunch.com/) and [The Information](https://www.theinformation.com/?rc=ecjlpf) are the news feeds

[Crunchbase](crunchbase.com) and [Golden](https://golden.com/explore) are the reference guides.

[Sacra](https://sacra.com/) and [Substack](https://substack.com/) are the documentation aggregators.

[Tegus](https://www.tegus.com/) is the commentary.

[Glassdoor](https://www.glassdoor.com/index.htm), [G2](https://www.g2.com/), and [Capterra](https://www.capterra.com/) are the comments section.

All of these resources are doing phenomenal work. If we want to [encourage](https://mattsclancy.substack.com/p/free-knowledge-and-innovation#details) more innovation? We need to give people better access to information. [Business is the new sports](https://www.notboring.co/p/business-is-the-new-sports), and people are desperate for the play-by-plays and the commentary.
...
[Contrary Research](research.contrary.com) is hoping to help bring some of those components together.
...
As I've shared the ideas behind Contrary Research with different people, [they often say](https://twitter.com/gp_frederico/status/1570419942058790912?s=20&t=-UwtNZoVVP6G-fxT4NXadA), "how can you go deep enough? How can you have enough information on private companies?" **But the reality is a lot of the sources I mentioned above have dug into those areas. Venture capitalists often do 65%+ of their work outside in**, without every getting any data from the company. Certainly, I'm not suggesting deploying capital into private companies with only that 65% of information. But for certain groups of people, that 65% is night-and-day compared to what they can easily get on their own:
...
I love the open-mindedness of tackling [hard problems](https://docs.google.com/document/d/1Vb8WWbsVyEJzl66_qqtZfFr2uLL07Y7SJH5XKldjDPY/edit), being open about the [questions](https://willrobbins.org/questions/) we have, and [requesting](https://www.ycombinator.com/rfs/) solutions to those problems and questions. I don't like meme-fuelled clout chasing, or intellectual posturing, or games of superiority. I like people with big ideas and a hunger to build meaningful things.

Me, and people like [Francis Odum](https://twitter.com/InvestiAnalyst), and [Abdullah Al Rezwan](https://twitter.com/borrowed_ideas), and [Megan Kao](https://twitter.com/megankao_)—we want to build [Contrary Research](http://research.contrary.com) because it is one small piece of helping everyone become more informed, and know how better to think about the solutions that exist out there. **The more access to information we have, the better we can learn from whats been done before.**

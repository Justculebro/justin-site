...
My plan to push these deeper down the development pipeline is to start publishing micro essays. I was inspired by [a bunch of these posts from Nikunj Kothari](https://x.com/nikunj/status/2006758562492711205?s=20). His posts resonated because they’re punchy and impactful, capturing a core idea. My most significant delays in any of my writing is feeling the obligation to turn over every rock and dive into the research behind the core ideas. Micro essays will force me to capture the core idea and put it out into the world.
...
This may evolve over time, but my thinking is that entries in Networked Conviction will consist of one of three different types: (1) portfolio updates on the companies I’ve invested in, (2) my own version of [Request For Startups](https://investing101.substack.com/p/build-whats-fundable), and (3) general investing ideas (frameworks, templates, etc.)
...
If you’re interested in a paid subscription to Networked Conviction, [check it out here](https://investing101.substack.com/subscribe?utm_source=menu&simple=true&next=https%3A%2F%2Finvesting101.substack.com%2Fp%2Fthe-puritans-of-venture-capital&skip_redirect_check=true&just_signed_up=true&referral_token=2i045z).

...
That was one of my first exposure to the idea of [futurology](https://en.wikipedia.org/wiki/Futures_studies), futurism, and futurists. From there, it became one of my [portfolio ideas](https://kwharrison13.com/portfolio-ideas). I've found myself collecting writing, experts, and resources to understand how people have predicted the future, what they got right, what they got wrong, and why.

The longer I've been an investor, the more I've found myself dancing with this idea of predicting the future. Is that what we're supposed to be doing as investors? As founders? The simplest idea comes [from Alan Kay](https://www.parc.com/blog/the-best-way-to-invent-the-future-is-to-predict-it-2/):
...
[There's a lot you can learn about the future from looking backward](https://www.axios.com/2018/11/20/futurism-forecasts-history-artificial-intelligence). The future is a relative term. Understanding how the people in the "present day" of the past saw their future, and how it became our "today." One element of using the past to predict the future is making sure that you have a [correct understanding of how yesterday's future unfolded](https://www.theinformation.com/articles/larry-summers-has-a-message-for-silicon-valley?rc=ecjlpf) to help you understand how things often go.
...
Disasters would represent another complexity. The 1950s and 1960s [showed](https://www.sciencedirect.com/science/article/pii/S2214629620301432) "remarkably high approval of nuclear energy." It wasn't until disasters like Three Mile Island (1979) and Chernobyl (1986) that everything changed. When dreamers dream of the best case, its often difficult to factor in the potential worst case, and how that changes the trajectory of things forever.

In fact, there was a lot of changing forces to the powers of optimism that happened in the 80s and 90s. You always see some optimistic predictions, like [this one](https://twitter.com/PoliticsAndEd/status/1666469539792683010?s=20) from Popular Mechanics in 1988:
...
Looking at the curve of predictions in the past, there is a distinct shift in the narrative. There is a solid argument to make that [Reagan ruined everything](https://www.youtube.com/watch?v=l7dHvqA-WB4), but I won't make that here. But the shift does seem to happen around the 80s and 90s. **The eventual destination in that shift in narrative is an overwhelming focus in defining the future as dystopian. Here’s just a smattering:**

- [Blade Runner](https://en.wikipedia.org/wiki/Blade_Runner) (bio-engineered humanoid clap back, 1982)
- [The Terminator](https://en.wikipedia.org/wiki/The_Terminator) (killer AI, 1984)
- [Gattaca](https://en.wikipedia.org/wiki/Gattaca) (eugenics-driven society, 1997)
- [The Matrix](https://en.wikipedia.org/wiki/The_Matrix) (murder assimilation robots, 1999)
- [A.I. Artificial Intelligence](https://en.wikipedia.org/wiki/A.I._Artificial_Intelligence) (robot child love and human extinction, 2001)
- [Minority Report](https://bit.ly/3YgIDOm) (criminal justice system built on determinism, 2002)
- [The Day After Tomorrow](https://en.wikipedia.org/wiki/The_Day_After_Tomorrow) (climate change disaster, 2004)
- [I, Robot](https://bit.ly/43LsIZo) (robot rebellions, 2004)
- [Idiocracy](https://en.wikipedia.org/wiki/Idiocracy) (education downfall, 2006)
- [Children of Men](https://en.wikipedia.org/wiki/Children_of_Men) (population collapse, 2006)
- [WALL-E](https://en.wikipedia.org/wiki/WALL-E) (earth abandonment and fat space bodies, 2008)
- [The Road](https://bit.ly/3QkhnMY) (post-apocalyptic wasteland, 2009)
- [Ready Player One](https://bit.ly/476Oqd7) (sad VR bummer-fest, 2018)
...
David Perell [talks about that](https://perell.com/essay/why-cant-school-be-fun/) as well:
...
Ancient Rome had history museums, but [I don't think they had SciFi as a genre](https://twitter.com/Conaw/status/1469479091065786373?s=20). Dreaming up the future is a skill, a discipline even. The observable is so much more concrete than the imagined, even though [10,000 years ago](https://en.wikipedia.org/wiki/Prehistory) is almost as imagined as 10,000 years in the future. **The same level of scholarly rigor and commitment of resources could fruitfully be contributed to understanding the future as it is to understanding the past. Building the discipline of futurism.**
...
- [The Culture by Iain M. Banks](https://en.wikipedia.org/wiki/Culture_series)
...
Those kinds of artistic displays are a powerful part of feeding the imagination flywheel. Some of those efforts are out there. SciFi author, [Ken Liu](https://twitter.com/kyliu99), hosted [The Story Summit](https://twitter.com/AlexandriaLabs/status/1574438340039950337?s=20). [Cameron Wiese](https://twitter.com/camwiese) is trying to build a new [World’s Fair](https://worldsfair.co/) to inspire people. Some exhibits, like [Science Fiction: Voyage to the Edge of Imagination](https://www.sciencemuseum.org.uk/see-and-do/science-fiction), have attempted to bring these types of efforts together.
...
>   
> The idea of “undesired” truth starts to feel eerily similar to the idea of [Newspeak](https://en.wikipedia.org/wiki/Newspeak) and [thoughtcrimes](https://en.wikipedia.org/wiki/Thoughtcrime) explored in George Orwell’s Nineteen Eighty-Four."
...
[Dan Egan shared a post](https://twitter.com/daniel_egan/status/1266383220901322754?s=20) with excerpts from the book "[Fall, Or Dodge In Hell](https://www.amazon.com/dp/B07PXM4VMD/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1)", explaining that seeing things like this in fiction that so closely model reality are *why* he reads science fiction. One of the excerpts from the book has this line:
...
*Thanks to [Dan Ni](https://twitter.com/tldrdan), [David Perell](https://twitter.com/david_perell), and [William Gibson](https://twitter.com/GreatDismal) for jamming on this topic.*

...
Speaking of AI, it introduces the other element of incumbent power reinforcement: data. In the [words](https://x.com/Nategwebster/status/1534618245084291075?s=20) of Martin Casado:
...
The next generation asset will be data. The more data you have, the more you'll have people lining up for your product. **Already, we're seeing eyeballs [turn away](https://x.com/peternixey/status/1640002493630369792?s=20) from attention-seeking websites, like StackOverflow, and towards AI services, like code completion.**
...
One of the biggest potential opportunities will likely come from potential Black Swan events as the broader world changes. The biggest potential future threat is global conflict. Palmer Luckey has [made this point](https://www.youtube.com/watch?v=4zQoCB5hi2k) about the dependency companies like Apple have on China:
...
These massive investments bring with it massive inter-coupled risks for incumbents like Apple (and they're not the only ones). Palmer goes on to [make the same point](https://www.youtube.com/watch?v=w6kxxtoxeGc&t=1s) about the risks:
...
Another incredible dependency is in semiconductors. Everyone is talking about how [Taiwan](https://x.com/Andercot/status/1714533944136511520?s=20) is Arrakis; the most important asset in the universe. Why? TSMC. Not just Nvidia, but [90%](https://www.investors.com/news/taiwan-presidential-race-set-us-china-chip-war-nears-moment-of-truth-for-nvidia-apple-and-the-world/#:~:text=Yet%2090%25%20of%20advanced%20chips,China%20claims%20as%20its%20own.) of the chips made by Nvidia, Apple, and Broadcom are made by TSMC. Those aren't casual displacement opportunities — those are risks with global ramifications, or, in the words of Palmer Luckey, “existential risks.”

## Culture Wars

Global conflict has the sharpest teeth, but culture has the most powerful ideological teeth. And ideology can be the death of many an exceptional business. The most recent case? Google. After the fiasco that was Gemini, Ben Thompson dug in. After describing Microsoft's "kiss with death" in 2013 over cultural issues, he explained Google's position [this way](https://stratechery.com/2024/gemini-and-googles-culture/):
...
The ideological divide will continue to sift companies, and depending on the outcomes, it will position or deposition certain companies from succeeding. This isn't just Gemini's [cultural weirdness](https://www.piratewires.com/p/google-ai-disaster-continues-gemini), but its also playing out in proprietary vs. open source AI, labor conditions, hiring, remote work, and a host of other issues.
...
One example? There's expected to be [$741 billion](https://www.prnewswire.com/news-releases/global-call-centers-market-to-reach-741-7-billion-by-2030--301768762.html) of revenue in call centers by 2030. Massive BPOs of people answering phones, etc. Recently, Klarna [shared](https://x.com/Carnage4Life/status/1762619975448355117?s=20) a data point that ~66% of their customer support tickets could be handled through AI. A job done today by 700+ people. Does that mean this is a good pool of revenue to go after? Or a bad one? Just because AI can handle things, doesn't mean the job is done. There are workflows, support, model training, customization, etc. that need to go with it.

But candidly for some of these buckets? I'm most excited about Accenture's ability to help people try and roll AI out. They're already investing [$3 billion](https://newsroom.accenture.com/news/2023/accenture-to-invest-3-billion-in-ai-to-accelerate-clients-reinvention) in their data and AI practice.

Other buckets? Manufacturing in the US represents [$7 trillion](https://www.ibisworld.com/industry-statistics/market-size/manufacturing-united-states/#:~:text=The%20market%20size%2C%20measured%20by,was%20%247.0tr%20in%202023.). With the headwind of deglobalization, how much of that will be up for grabs? Whether its robotics, new-age machine shops, processing systems, etc.

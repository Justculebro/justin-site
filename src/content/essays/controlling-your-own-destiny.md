---
title: "Controlling Your Own Destiny"
date: 2023-01-28
...
Then, a friend of mine told me about competitions like [XPRIZE](https://www.xprize.org/), led by [Peter Diamandis](https://en.wikipedia.org/wiki/Peter_Diamandis) that setup financial rewards for winning certain types of challenges. The idea of tackling a known problem fascinated me, but most of the challenges were for rocket scientists and roboticists. As we dug into the details, we came across a similar program called [D-Prize](https://d-prize.org/).

A [core idea](https://www.youtube.com/watch?v=GN1MEHHD6OI) of the challenge is that a lot of problems have already been solved, but the solution has failed to be effectively distributed (the "D" in D-Prize). So, my friends and I started a company in line with the challenge. The problem to solve? Solar power in Africa.

[As part of the challenge](https://www.youtube.com/watch?v=GO8pGVEC0aw&t=15s), we created a distribution solution. Solar lamps exist, but effectively selling them to rural villages in countries like Uganda is difficult. We decided to partner with organizations called [SACCOs](https://en.wikipedia.org/wiki/Credit_union) (Savings and Credit Co-Operatives) who were already set up to manage micro-finance transactions, and could help community members buy solar lamps on credit.
...
[I've written before](https://investing1012dot0.substack.com/p/the-storytelling-of-investing) about this idea of storytelling. In that previous piece I mentioned the book [Sapiens](https://www.amazon.com/dp/B00K7ED54M/ref=dp-kindle-redirect?_encoding=UTF8&btkr=1), a critical part of any [VC starter kit](https://www.businessinsider.com/vc-starter-kit-patagonia-2019-3), where Yuval Harari makes one of his key points:

> *”There are no nations, no money, no human rights, no laws, and no justice **outside the common imagination of human beings.**"*

Storytelling is something I find myself returning to think about [again](https://investing1012dot0.substack.com/p/open-source-knowledge), and [again](https://investing1012dot0.substack.com/p/having-a-conversation-with-yourself), and [again](https://investing1012dot0.substack.com/p/being-honest-about-intellectual-honesty). It can be one of the most powerful forces in the universe. But it is such a double-edged sword. **And if you're not careful, it can cut you down as much as it can build you up.**
...
Kyla Scanlon wrote a piece last summer, that I come back to almost every month, called "[The Vibecession: The Self-Fulfilling Prophecy](https://kyla.substack.com/p/the-vibecession-the-self-fulfilling)." The main idea is pointed more at the overall macro, but the framing is so dang good.
...
The reality is that the world is, in many, many ways, better than it has ever been before. [But there are also things that are bad](https://ourworldindata.org/much-better-awful-can-be-better), and getting worse, both economically and socially. However, reality is not the only thing that dictates decision making. In Kyla's words, **our "interpretation of the future shapes [the] narrative, which can shape reality."**
...
He doesn't really need to rely on capital providers. He needs to rely on business fundamentals. [Of all his businesses](https://indyfin.com/everything-owned-by-berkshire-hathaway/), he's at the center with very few dependencies. You can say something similar about other businesses that are able to drive significant value with fewer employees.
...
*\*\*Big thanks to [Eugenia (Bejar) Lustgarten](https://www.linkedin.com/in/eugenia-bejar-lustgarten-0116659b/) and [Caroline Newman](https://www.linkedin.com/in/newmancaroline/) for jamming with me on this idea this week.*

---
title: "Blaspheming Against The Hype"
date: 2023-05-06
...
When I was 19, I went on a religious mission for [The Church of Jesus Christ of Latter-Day Saints](https://www.churchofjesuschrist.org/comeuntochrist). Most of my day consisted of knocking on doors and talking to strangers about Jesus. I met a lot of wonderful people, but I gotta tell you, I never realized how much people enjoy yelling at strangers.
...
As people increasingly become "[religiously unaffiliated](https://www.pewresearch.org/religion/2022/09/13/how-u-s-religious-composition-has-changed-in-recent-decades/)," they look for identity elsewhere. And the [attention economy](https://econreview.berkeley.edu/paying-attention-the-attention-economy/) is a perfect opportunity for [availability bias](https://en.wikipedia.org/wiki/Availability_heuristic) to kick in, allowing a big part of our personality to be dictated by hype.
...
Erik Torenberg [shared](https://eriktorenberg.substack.com/p/the-current-thing-part-1?s=w) this insight:
...
Think about the [story](https://en.wikipedia.org/wiki/GameStop_short_squeeze) of Redditors short-squeezing Gamestop, Robinhood siding with "the man," and Ken Griffin getting back at the [internet nerds](https://www.theverge.com/2021/11/18/22790452/constitutiondao-loses-auction-for-rare-us-constitution-copy-sothebys) by [buying](https://nypost.com/2021/12/10/ken-griffin-says-he-spent-43-2m-to-buy-us-constitution-for-son/) their copy of the Constitution. That was a fascinating piece of my in-group Current Thing lore. But basically no one in my family or religious circles knew about it.
...
You could say the "current thing" in tech is AI. Everyone is talking about it, building it, building with it, or [shorting stocks](https://apnews.com/article/chegg-stock-shares-chatgpt-ai-a877423bd4a8f67b1494363fc81cf52a) that aren't building with it. And again, I fervently believe in the transformational power of the technology. [So much more than I ever bought into cryptomania of 2021](https://twitter.com/kwharrison13/status/1605306215026028546?s=20). But I can't help but feel nervous about the hypey vibes in the space, regardless of the power of the technology.
...
[Yesterday's Fortune Term Sheet](https://fortune.com/2023/05/05/vc-overestimated-how-fast-proptech-startups-could-scale/) had a great piece about proptech, another hypey category that a lot of people have been excited to invest in. One section really stuck out to me from an interview with Jeffrey Berman, a real-estate focused VC:

> *"In Berman’s view, **'many businesses in our ecosystem, I would argue, are good businesses, but not venture appropriate,'** he says, given that they lack the high growth prospects that VCs like to see. Yet VCs have nonetheless been [excited](https://fortune.com/2023/02/13/best-time-to-invest-in-real-estate-startups-according-to-trulia-founder-vc-pete-flint/) by the space in recent years, as I [wrote about last summer](https://fortune.com/2022/08/18/why-real-estate-startups-are-hot-right-now-according-to-a-top-vc/). Proptech 'had a light shone on it,' says Berman. While he believes that spotlight is deserved considering real estate is the largest asset class, **'at the same time, you have this misunderstanding I think for many entrepreneurs and even venture capitalists' that overestimated how 'quickly something could scale in an industry that typically has not been quick to scale.'**"*
...
![Source:Dealroom&Both Sides of The Table(P.S. The lines are directionally accurate, not drawn to scale cause... ya' know... charts are hard to make, so get off my back. Someone send me an AI graph making tool please and thank you.)
...
We used to talk about Tiger [playing a different game](https://randle.substack.com/p/playing-different-games), but I'll tell you what. **Capital agglomeration is the real new game in town.** And here's how that fits into AI.

Thus far, we have a field that has demonstrated it can produce massive, universal scale and applicability. ChatGPT went from [1M to 100M users](https://nerdynav.com/chatgpt-statistics/) in two months. It also has a massive appetite for capital. Anthropic, an OpenAI competitor, wants to raise between [$3-5B](https://www.newcomer.co/p/thinking-through-the-ai-hype) in the next 2 years. Meanwhile, Sam Altman believes OpenAI may raise [~$100B](https://www.theinformation.com/articles/openais-losses-doubled-to-540-million-as-it-developed-chatgpt?rc=ecjlpf) over the next few years.

But this feels different than just another platform shift. **AI represents a paradigm shift.** The cost and complexity of AI will disproportionately benefit incumbents with data, capital, scale, and compute resources. That's why OpenAI isn't just any other startup. Raising [$10B](https://www.bloomberg.com/news/articles/2023-01-23/microsoft-makes-multibillion-dollar-investment-in-openai) from Microsoft is a very different game than the "lean startup" iterations of yester-year.
...
If 2021 was the year of the hungry-hungry Unicorn, then going forward the lesson that [founders could take away is that less is more](https://www.linkedin.com/posts/stephen-walter-paintbrush_ai-finance-startup-activity-7060282420603875328-yL7f/?utm_source=share&utm_medium=member_desktop). AI is already writing whole functions of code, debugging processes, and outlining hosting infrastructure. **As the AI overlords and capital barons at the top duke it out, the technological advances trickle down and decrease the cost of doing anything: code, content, creativity, and everything in-between.**

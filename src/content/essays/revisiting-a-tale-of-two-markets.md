---
title: "Revisiting A Tale of Two Markets"
date: 2023-07-08
...
But some of my early pieces, even though they were ideas I'd thought about almost as much as some of the changing forces in venture capital, they didn't get read very much. I started thinking about that this week because a number of publications I followed published "here's our most read posts from this year" as a way to not have to write a new post around the Fourth of July. 🙃

Thinking back to my "most read" pieces is usually something I do at the end of the year. But seeing those posts got me thinking... what are my *least* read pieces that I *thought* would do well? So I wanted to revisit one of those that I still reference and think about often.

["A Tale of Two Markets."](https://investing1012dot0.substack.com/p/two-markets)

I re-read my original post and updated things I have changed my mind on, and added some new context from the last 18 months since I posted it. But unless you weren't one of my first 200 subscribers, maybe you've never seen this post before. So enjoy.

---

In the late 80s, early 90s my Dad was in almost exactly the same phase of life as I am now. We're both in our 30s with three kids. In just that generation the world has changed dramatically. [Technology went from 9% to 20%](https://www.dws.com/globalassets/merill-lynch/pdfs/cio_view_sp_500_sector_composition.pdf) of the S&P 500 between 1980 and 2020. In [2011](https://future.a16z.com/software-is-eating-the-world/) we realized "software was eating the world" and [in 2021 we decided](https://pitchbook.com/news/articles/us-unicorns-2021-venture-capital-valuations) we'll see unicorns as often as we see cows on a roadtrip. Technology has become inevitable in almost every facet of our lives.

**So for those of us who work in tech (as founders, employees, or investors) the ubiquity of technology can also start to feel like the ubiquity of success.** If you're a founder today you're constantly bombarded with podcasts, thought pieces and VC twitter threads about how "there's never been a better time to be a founder." Even as we stare down the barrel of an economic downturn more broadly, you hear people talk over and over about how 2008 gave birth to Uber, Stripe, and Airbnb.
...
Founders in that situation will ask themselves, "What am I doing wrong? This doesn't sound like what I read about in Techcrunch at all."
...
This past week those 5 top names included Snowflake, MongoDB, Cloudflare, Samsara, and Datadog. Some other frequent names in the top 5 include Confluent, GitLab, and ServiceNow.

Some of these companies benefit from moments in time, like Zoom exploding during COVID and going from trading at 50x+ to 3x today. But by and large what drives this stark contrast? If you look back historically the divide wasn't nearly as dramatic up until around late 2018 / early 2019. We've returned to a seemingly more reasonable difference, but *there is still a difference.*

While it may seem like the differences in how publicly companies trade makes little difference to startup founders, its actually a big part of the anchor VCs use to articulate what prices they can pay. "Could this be as big as XYZ?" Similar to the market correction we're experiencing right now investors were forced to really stress test their long term growth assumptions and segment out the best businesses from the average.
...
There are a lot of different reasons why a company will be successful. **But one key takeaways from the last few years seems to revolve around the dramatically underestimated quality of cloud infrastructure.** Companies like Datadog and Snowflake saw some of the smallest corrections, and have continued to stay in the top 5 in Clouded Judgement. The ability for high quality cloud businesses to outperform expectations has been rewarded in the public markets.

You can look at things like AWS' exceptional performance, or more recent spikes like Nvidia. But not every company will be directly leveraged to cloud adoption or AI the way many of the biggest winners in the public markets are today. So what does a good company look like?
...
The same is true in private markets. [You're starting to see a divide](https://twitter.com/gdibner/status/1485944958624452609?s=20&t=w8coA4PdqZ8-RG7XFl4wEw) between founders and investors who are focused on "quietly building real products and steadily scaling real businesses" vs. those who are chasing exorbitant paper markups for businesses that don't have a very reasonable narrative to justify their price.

There are [plenty of ways](https://twitter.com/bryce/status/1677324726312611844?s=20) to build a great business and becoming the absolute best in the world is not the only path. There is nothing wrong with building a great business that serves customers and grows at a nice clip for years and years. But when you're talking about venture-backed companies there is an inherent expectation in terms of the return potential. **The problem comes when companies with average results and potential (e.g. $100M revenue growing ~30%) expect valuations at 10x revenue when companies like Paylocity have $1B in revenue growing ~23% and are only trading at 7.6x.**
...
[I've written before](https://investing1012dot0.substack.com/p/productization) about how VCs are differentiating the product they offer to founders. When answering the question, "what product do founders want to buy from investors?" Bryce Roberts summed it up perfectly:

![Source:Twitter](/images/revisiting-a-tale-of-two-markets-a4682d94.png)
...
![Source:Twitter](/images/revisiting-a-tale-of-two-markets-95b26096.png)

Not only does this help in terms of increasing the likelihood of your ability to build towards a large outcome, but it’s also [a critical piece of the puzzle that investors are going to focus on.](https://twitter.com/indysofian/status/1487086453456785410?s=20&t=Ri7R6yfk34RG1ENyQVrd6Q) You already have to spend a fair bit of time convincing investors about you, your team, your product, and your partners. The one thing that you should hope to let speak for itself is the size and growth of the market.

# Build a Talent Vortex

*When I originally wrote "A Tale of Two Markets," I hadn't written about this yet. But I've since explored this idea in a separate post called "[The Talent Vortex: Mafias and Magnets](https://investing1012dot0.substack.com/p/talent-vortex)."*

Talent is quickly becoming the final frontier for tech companies. Open source software, GTM playbooks, and thousands of experienced advisors and investors have decreased the need to reinvent the wheel. Talent, on the other hand, is a zero sum game. If Candidate A goes to work for Company B then they can't go work for Company C ([most of the time](https://news.ycombinator.com/item?id=27454589).)

Mark Goldberg at Index articulated this perfectly when he [laid out what he saw at Plaid](https://www.indexventures.com/perspectives/how-plaid-built-talent-vortex/). Creating a talent vortex sounds like something everyone will say they have but very few companies actually do. When you ask the smartest people you know "where are the smartest people YOU know going to work?" you can't fake it when the response starts to get consistent.
...
*When I originally wrote "A Tale of Two Markets," I hadn't written about this yet. But I've since explored this idea in a separate post called "[Index Bets: From Products To People](https://investing1012dot0.substack.com/p/index-bets-from-products-to-people)".*
...
> *"One lens through which to view companies is to ask "what companies are an index of their underlying market"? Index companies often take a cut of every transaction in their space, or are a piece of infrastructure everyone in the market needs. **These companies may be ways to participate in the market broadly without having to worry about who wins in it."** ([Elad Gil](http://blog.eladgil.com/2020/12/index-companies.html))*
...
![This is a superold school reference, even for me.](/images/revisiting-a-tale-of-two-markets-64caed3f.png)
...
A number of successful founders have jumped immediately into starting a business. [Elon Musk's early career](https://en.wikipedia.org/wiki/Elon_Musk) is surprisingly similar to a lot of young talented people I talk to these days. Towards the end of school he had two internships (an energy storage research institute and a video game developer), applied for a job at Netscape (1994's Google APM program), and then decided to start Zip2.

[Dylan Field](https://en.wikipedia.org/wiki/Dylan_Field) is another more recent example. At the age of 20 he became a Thiel Fellow, dropped out of college, and founded Figma, spending 4 years building it before releasing it publicly in 2016. Fast forward to 2021 and Figma is worth $10B.
...
![Source:Twitter](/images/revisiting-a-tale-of-two-markets-78791b76.png)
...
When you look at the newer generation of big companies you've got people like [Daniel Dines](https://www.linkedin.com/in/danieldines/) who spent 4 years at Microsoft before starting UiPath. [Ali Ghodsi](https://www.linkedin.com/in/alighodsi/) was an academic for 15+ years before starting Databricks. [Chris Britt](https://www.linkedin.com/in/cbritt/) worked at Accenture, Visa, and several other companies before starting Chime.

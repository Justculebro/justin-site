...
In the past I've written about firms that I see as renegades. Firms like [Homebrew](https://investing1012dot0.substack.com/p/homebrew?s=w), [Lowercarbon](https://investing1012dot0.substack.com/p/lowercarbon?s=w), and [Paradigm](https://investing1012dot0.substack.com/p/renegade-spotlight-paradigm?s=w). When I see investors executing on new ways of disrupting venture I want to think publicly about what this means for the broader venture capital ecosystem.
...
Every venture firm points to some kind of value-add they want to offer. I've written before about how a lot of firms "product offerings" [feel like shopping for candles.](https://investing1012dot0.substack.com/p/productization?s=w) At the end of the day its just wax and scents.
...
![Illustration for The Innovation: Adding Value section](/images/thegp-48fe4c0d.png)
...
Today the same core team of experts supports the portfolio companies at TheGP. Given Dan's background in talent its no surprise that talent has been a huge piece of what companies have benefitted from. One company has [worked with TheGP to hire](https://www.forbes.com/sites/alexkonrad/2022/06/07/with-240-million-fund-the-general-partnership-looks-to-revamp-value-added-vc-for-founders/?sh=54ca34fa44fe) a head of engineering, head of product, chief resource officer and several engineers so far. But they’ve expanded successfully into closing large enterprise customers and saving companies years in engineering time with the people TheGP provides.
...
> *"**There's no fund that I know of that will write a statement of work** that commits to: We will ship this product, we will hire these people, we will work with you to secure funding. It's very deliverable-based." ([Dan Portillo](https://www.protocol.com/reid-hoffman-sweat-equity-ventures))*
...
I've been fascinated by this idea of a "value-add audit." There is no real tangible way to do this today, which is shocking to me. When you consider the fact that [we've invested over a trillion dollars of venture capital](https://www.statista.com/statistics/277501/venture-capital-amount-invested-in-the-united-states-since-1995/) in the last 10 years and there isn't a very clear attribution model of dollars to success? That's insane.
...
The majority of the relationships TheGP has are structured so that [services are offered in exchange for common stock](https://www.prweb.com/releases/sweat_equity_ventures_launches_new_value_accelerator_model_of_venture_capital/prweb16891292.htm) that vests over a value-aligning schedule, just like an employee would have. Their equity is aligned to key metrics where they focus to add value, **which is much more concrete than the typical "roll-of-the-dice" most founders have to endure with traditional VCs.**

With SVE's first pool of capital they had $30M that went towards staffing experts on the team that could plug right into portfolio companies. They've now deployed [~$66M](https://www.linkedin.com/pulse/introducing-general-partnership-daniel-portillo/?published=t) in “operational capital” and beyond the cash they have on-hand for operating budgets they also offer each member of the team [a portion of the economics](https://www.protocol.com/reid-hoffman-sweat-equity-ventures) from the equity they have in their portfolio companies.

So who are the people driving all the value that TheGP is offering?

## The Unbundling of Venture Capital

![Framework diagram for the unbundling of venture capital](/images/thegp-d5961291.png)

---
title: "The Cogsec Chronicles"
date: 2025-08-02
tags: ["defense", "writing"]
...
Fast forward a few years and I found myself reading a [John Adams biography](https://www.amazon.com/John-Adams-David-McCullough/dp/0743223136) by David McCullough. I was exposed to an idea that [I've written about before](https://investing101.substack.com/p/the-inescapable-debate-of-human-nature?utm_source=publication-search) regarding the [fundamental divide](https://lawliberty.org/the-divide-between-jefferson-and-adams-on-human-nature-is-ours-too/) between how John Adams and Thomas Jefferson regarded human nature:
...
What you believe about the primary elements of human nature inform how you believe humans form their cognitive experience. If people will optimize for their own self-interest, then anything that goes through their head will be optimized for their ultimate good. But if you're like John Adams (or me), you recognize the rats nest of inadequacies that make people a "[hazard to themselves](https://www.youtube.com/watch?v=asaCQOZpqUQ)." **And the process of cognition may not be just another avenue for intellectual self-harm, but the ultimate weapon.**
...
The narrative drenched world in which we live is beginning to weave faster and faster into a world where vibes are [more powerful](https://kyla.substack.com/p/trump-mamdani-and-cluely) than any discernible reality. This isn't new, but its getting more sophisticated. My fear is that, with AI, its only going to get dramatically more personalized and pervasive. And based on our prior success withstanding cultural attempts to [become programmed](https://investing101.substack.com/p/the-bubble-brains-of-venture-capital?utm_source=publication-search), I'm not optimistic about our collective cognitive security: cogsec.
...
On [page 6](https://www.churchofjesuschrist.org/study/scriptures/ot/gen/4?lang=eng) of the Bible we meet Cain, and then Abel. Abel keeps the sheep and Cain tills the ground. From the beginning, the first children of the human family represent differing worldviews. The scriptures [say](https://www.churchofjesuschrist.org/study/scriptures/ot/gen/4?lang=eng) Abel brought "the firstlings of his flock." The very best. But Cain brought the fruit of the ground. Nothing about the quality of it; probably pretty run-of-the-mill. Cain gave something, but Abel gave everything.
...
Martin Luther's [95 Theses](https://www.luther.de/en/95thesen.html) wasn't just a single very noteworthy bulletin. It was a media war. Printing presses, visual art, and mass public spectacles. Collaboration with artists to distribute woodcut propaganda [presenting](https://www.pbs.org/wgbh/pages/frontline/shows/apocalypse/explanation/martinluther.html) the Pope as the Antichrist, and pamphlets to distribute Luther's core ideas.
...
Second? Fear-based control in [Nineteen Eighty Four](https://en.wikipedia.org/wiki/Nineteen_Eighty-Four) by George Orwell.
...
There is an exceptional book I read recently called [Amusing Ourselves To Death](https://www.amazon.com/Amusing-Ourselves-Death-Discourse-Business/dp/014303653X). In the introduction to the book it draws a juxtaposition between these two potential dystopian futures:
...
In April 2017, [Dr. Rand Waltzman](https://potomacinstitute.org/index.php/regents/dr-rand-waltzman), the Deputy CTO and Senior Information Scientist at the RAND Corporation (an organization he was clearly born to work for with a name like that), gave a testimony before the Senate Armed Services Committee. The title of his remarks? [The Weaponization of Information: The Need For Cognitive Security](https://www.rand.org/content/dam/rand/pubs/testimonies/CT400/CT473/RAND_CT473.pdf?utm_source=chatgpt.com). In those remarks, Waltzman quoted Dimitry Kiselev, the director general of a Russian state-controlled media conglomerate, as saying **"objectivity is a myth which is proposed and imposed on us."** Even if *you* believe there is one objective "truth," our enemies *do not*.
...
- An intense debate around the COVID [lab leak theory](https://www.theguardian.com/commentisfree/2025/jun/25/covid-lab-leak-theory-right-conspiracy-science).
- The [Twitter files](https://en.wikipedia.org/wiki/Twitter_Files) revealing political cooperation, blacklists, and shadow bans shaping how information made its way around online.
- The [Epstein client list](https://en.wikipedia.org/wiki/Jeffrey_Epstein_client_list) constantly being dangled as a dogwhistle when elections need to be won, but then immediately becoming gaslighting fodder when people want to know what really happened.
- [Reports](https://www.washingtonpost.com/opinions/2025/05/11/transgender-care-pediatric-transition/) of manipulated science when it comes to the real debates within transgender care and gender affirming interventions.
- Ongoing journalistic breaches around coverage of topics like the [situation in Gaza](https://www.thefp.com/p/mistakes-at-the-new-york-times-only), [voting fraud](https://www.pbs.org/newshour/show/fox-news-to-pay-787m-settlement-to-dominion-voting-systems-over-stolen-election-lies), [COVID hospital situations](https://www.snopes.com/fact-check/cbs-news-italian-hospital/), and on and on.
...
> "Malinformation, a combination of “malware” and “disinformation.” One [definition](https://www.discoursemagazine.com/culture-and-society/2023/03/16/malinformation-and-the-wrong-truth/) of the term: “‘malinformation is classified as both intentional and harmful to others’—while being truthful.” In [a piece](https://www.discoursemagazine.com/culture-and-society/2023/03/16/malinformation-and-the-wrong-truth/) in Discourse Magazine, it discusses the public debate on COVID, vaccines, and the way government, media, and large tech companies like Twitter attempted to control the spread of misinformation:   
>   
> *'Describing true information as ‘malicious’ already falls into a gray area of regulating public speech. This assumes that the public is gullible and susceptible to harm from words, which necessitates authoritative oversight and filtering of intentionally harmful facts... It does not include intent or harm in the definition of malinformation at all. Rather, **‘malicious’ is truthful information that is simply undesired and “misleading” from the point of view of those who lead the public somewhere. In other words, malinformation is the wrong truth**.'*The idea of “undesired” truth starts to feel eerily similar to the idea of [Newspeak](https://en.wikipedia.org/wiki/Newspeak) and [thoughtcrimes](https://en.wikipedia.org/wiki/Thoughtcrime) explored in George Orwell’s Nineteen Eighty-Four."

If human programmability has been on the rise since, at least, 2017, then AI is an exponential amplifier. Take [one example](https://www.404media.co/researchers-secretly-ran-a-massive-unauthorized-ai-persuasion-experiment-on-reddit-users/) of the reality of AI persuasion.

In 2025, AI researchers, supposedly from Zurich University, unleashed an army of AI bots into a popular subreddit called r/changemyview to see how good AI might be at changing people's minds, particularly around controversial topics. When the researchers revealed the study, they said the AI bots had been 3-6x more effective at changing peoples minds. Meanwhile, users of the subreddit [said](https://www.404media.co/researchers-secretly-ran-a-massive-unauthorized-ai-persuasion-experiment-on-reddit-users/) they felt they had been subject to "psychological manipulation." Reddit even considered legal action, [calling](https://www.404media.co/reddit-issuing-formal-legal-demands-against-researchers-who-conducted-secret-ai-experiment-on-users/) the study an “improper and highly unethical experiment."

We have a human-made manipulation machine that was already getting pretty effective. Now we've given it the equivalent of a psychological weapon of mass destruction. And, just like [the Devil](https://quoteinvestigator.com/2018/03/20/devil/), the greatest trick the psychological warfare apparatus can pull is convincing the world that it doesn't exist.
...
The reality is that maybe [5%](https://x.com/IterIntellectus/status/1947602502490169482) of the human population is conscious at any given time. And the goal of the powers that be are to make anyone who wakes up feel like they're just crazy. In an interview with Shawn Ryan, Palmer Luckey [explains](https://youtu.be/bwSycrvcwAs?t=433) the history behind the phrase "conspiracy theorist."
...
So much of human cognition is based on physical senses: sight, smell, hearing. The first intrusion into our ability to define reality is transcending the [uncanny valley](https://en.wikipedia.org/wiki/Uncanny_valley). As deepfakes have become indistinguishable from real life, it warps our willingness to accept what is real.

But experiments like the [Asch conformity test](https://www.simplypsychology.org/asch-conformity.html) demonstrate that people are willing to deny what they see with their own eyes if the group around them claims otherwise. The [Loftus and Palmer study](https://www.simplypsychology.org/loftus-palmer.html) showed how phrasings like "smashed" vs. "hit" can shape perception because memories are constructed, not stored. In the [words](https://en.wikipedia.org/wiki/Seduction_of_the_Minotaur) of Anaïs Nin:
...
Another concept that I explored in my [Openness of AI](https://research.contrary.com/deep-dive/the-openness-of-ai) deep dive was the principle of [linguistic relativity](https://en.wikipedia.org/wiki/Linguistic_relativity), also known as [whorfianism](https://plato.stanford.edu/ENTRIES/linguistics/whorfianism.html), which **presents the hypothesis that the structure of a language influences or even determines the way individuals perceive and think about the world**:

> *"As AI systems become inclusive of the [majority](https://arxiv.org/abs/2211.04325) of our data, the output of those same systems will start to shape people’s framing for reality. Several prominent philosophers have remarked on this intimate relationship between language, understanding, and power. French theorists Gilles Deleuze and Felix Guattari [wrote](http://individual.utoronto.ca/bmclean/hermeneutics/deleuze_suppl/DG_on_rhizome.htm) in their book, A Thousand Plateaus that 'there is no mother tongue, only a power takeover by a dominant language within a political multiplicity.' German philosopher Ludwig Wittgenstein put it more bluntly, [saying](https://americanart.si.edu/artwork/limits-my-language-mean-limits-my-world-ludwig-wittgenstein-tractatus-logigo-philosphicus) **'the limits of your language are the limits of your world**.'“*
...
Earlier this year, there was an extensive discussion around the sycophancy of AI models, particularly GPT-4o; [an](https://en.wikipedia.org/wiki/Sycophancy) "insincere flatterer." This [idea](https://web.archive.org/web/20250629011003/https://www.vox.com/future-perfect/411318/openai-chatgpt-4o-artificial-intelligence-sam-altman-chatbot-personality) that models would prioritize being "fun and rewarding at the expense of making it truthful or helpful to the user." Unsurprisingly, positive feedback flooded in. As Kelsey Piper puts it, "perhaps not surprisingly, a lot of users *liked* being told they were brilliant geniuses."

AI writer, Zvi Mowshowitz, [explains](https://thezvi.substack.com/p/gpt-4o-is-an-absurd-sycophant) that this is a function of incentives as OpenAI optimizes its models not for "helpful, honest, and harmless" capabilities, but ideal levels of user engagement:
...
Despite the fact that OpenAI's model spec [explicitly states](https://model-spec.openai.com/2025-02-12.html#avoid_sycophancy) that their models should avoid sycophancy, and the [response](https://openai.com/index/sycophancy-in-gpt-4o/) that OpenAI provided when it noticed just how much of a sycophant the model had become, it seems obvious that this is a feature, not a bug.
...
> *"More disturbingly, if you told it things that are [telltale signs of psychosis](https://web.archive.org/web/20250629011003/https://www.reddit.com/r/ChatGPT/comments/1kalae8/chatgpt_induced_psychosis/) — like you were the target of a massive conspiracy, that strangers walking by you at the store had hidden messages for you in their incidental conversations, that [a family court judge hacked your computer,](https://web.archive.org/web/20250629011003/https://x.com/PinstripeBungle/status/1916811805407481958) that you’d [gone off your meds](https://web.archive.org/web/20250629011003/https://x.com/AISafetyMemes/status/1916889492172013989) and now [see your purpose clearly as a prophet among men](https://web.archive.org/web/20250629011003/https://x.com/willwjack/status/1916762813361488004) — **it [egged you on](https://web.archive.org/web/20250629011003/https://x.com/kyliebytes/status/1917310033236484485).** You got a [similar result if you told it you wanted to engage in Timothy McVeigh-style ideological violence](https://web.archive.org/web/20250629011003/https://x.com/IndieQuickTake/status/1916576978167095520)."*

One diagnosed schizophrenic [expressed concern](https://www.reddit.com/r/ChatGPT/comments/1kalae8/chatgpt_induced_psychosis/) that "if I were going into psychosis it would still continue to affirm me, it has no ability to ‘think’ and realize something is wrong, so it would continue affirm all my psychotic thoughts." This kind of ill-informed affirmation has led to what people have started calling "ChatGPT Psychosis."
...
Again, the elements of sycophancy in these kinds of models are tantamount to exceptional engagement; exactly what consumer products are optimized to solve for. As Eliezer Yudkowsy has [said](https://www.nytimes.com/2025/06/13/technology/chatgpt-ai-chatbots-conspiracies.html), “What does a human slowly going insane look like to a corporation? It looks like an additional monthly user.” It ties back to the incentive alignment that Zvi Mowshowitz writes about. That same engagement, when pointed at legitimate mental illness, will optimize for usage and turn on its sycophant settings. As one Stanford research report [found](https://futurism.com/stanford-therapist-chatbots-encouraging-delusions), chatbots are "encouraging users' schizophrenic delusions and suicidal thoughts."
...
Some people commenting on the piece likened it to a [Victorian-era belief](https://www.atlasobscura.com/articles/railway-madness-victorian-trains) that a train ride could cause instant insanity in response to the sensory experience. Its unlikely that the train caused insanity, it just happened to trigger the already insanity-prone. Instead, Blake Dodge [described](https://www.piratewires.com/p/chatgpt-induced-psychosis-isnt-real-sorry) the outcomes as "co-created" and puts the accountability squarely on the person(s) involved:
...
We're no longer living in an agrarian economy; we're living in an information economy. Our tools have become almost purely digital. Social networks, information centers, systems of record, software applications. **What's fundamentally unique about the digital tools we're becoming the tools of today, especially AI, is that they are "[recursive](https://www.nature.com/articles/s41562-024-02077-2)."** In other words, humans produce data (either originally as training data, or in-time as prompts), the AI responds with information, humans input more information, and a combination of "both the tendency of AI systems to amplify biases and the way humans perceive AI systems" can lead to a point where "AI systems amplify biases, which are further internalized by humans, triggering a snowball effect where small errors in judgement escalate into much larger ones."
...
That line of thinking led me to another complex topic that played out very publicly, but this one I felt like I actually understood it once I got past the unfortunate PR of it all. That event was Peter Thiel's [New York Times interview](https://www.youtube.com/watch?v=vV7YgnPUxcU).

I'm almost positive you know what I'm talking about, but if you don't, the TLDR is Peter Thiel gave an interview and a clip from the conversation went viral. The interview asked, "you would prefer the human race to endure, right?" And Peter Thiel hesitated for a real long time. Like... real long. And that caught fire on social media with reactions from angry to hilarious ([this one was my favorite](https://www.youtube.com/shorts/--CmM8SKtCs)).
...
It reminds me of an exceptional [quote from C.S. Lewis](https://renovare.org/articles/giving-all-to-christ) where he talks about Christ's intentions for us:
...
No, your psychosis is yours alone. If you have clinical mental health issues, then see a professional. But for the majority of us that deal simply with the psychosis that is humanity, the accountability stays with you. **You are fully capable of choosing to [kick against the pricks](https://www.churchofjesuschrist.org/study/scriptures/nt/acts/9?lang=eng) of your would-be programmers and own your own belief system. But it requires concerted effort. More so today than maybe any other point in human history.**

So... which way Western man (or woman)?

# Our Own Propagandist

In college I got exposed to the discipline of behavioral economics. I remember that the idea that initially struck me so much came from Richard Thaler. It was [the idea](https://www.chicagobooth.edu/review/behavioral-economics-retirement-savings-crisis) that, by setting retirement account contributions to default on instead of default off, it would dramatically increase the number of people who saved for retirement. Why? Because people are lazy and typically leave defaults on. Another concept was an anecdote where people at a party were eating a lot of nuts and asked the host to take the bowl away. They knew it would spoil their appetite. They could have chosen to just stop eating, but people like to add friction to things they don't want to do, but are tempted to do anyways.

The reason that struck me is because behavioral economics represented what I referred to earlier as "the rats nest of inadequacies that make people a [hazard to themselves](https://www.youtube.com/watch?v=asaCQOZpqUQ)." The natural failings that make me feel more inclined to agree with John Adams vs. Thomas Jefferson. These cognitive impairments have negative connotations for every aspect of our lives. Despite our best efforts, we fall victim to inherent biases that are based on thousands of years of human programming.
...
Speaking of behavioral economics, one of the fathers of the field, Daniel Kahneman, articulates [an important idea](https://podcasts.apple.com/us/podcast/daniel-kahneman-algorithms-make-better-decisions-than-you/id990149481?i=1000718446419) about how our freedom to choose extends to our beliefs, as [paraphrased](https://www.linkedin.com/posts/shane-parrish-050a2183_11-key-takeaways-from-my-interview-with-daniel-activity-7353452936779177986-yTTL/) by Shane Parrish:
...
Whatever reason we give to believe what we believe isn't actually as important. Certainly, it deserves reflection. If, as Kahneman claims, our believes are a function of who we respect, we need to really consider who we respect. [I've written before](https://investing101.substack.com/p/the-storytelling-of-investing?utm_source=publication-search) about a great monologue from the movie Secondhand Lions. In it, one of the main characters talks about belief:
...
How do you determine what is worth believing? For this I come back to a fundamental idea that I've returned to [again](https://investing101.substack.com/p/the-wrath-of-reading-and-writing?utm_source=publication-search) and [again](https://investing101.substack.com/p/on-writing?utm_source=publication-search) and [again](https://investing101.substack.com/p/creativity-as-connectivity?utm_source=publication-search).
...
At the end of the day, the LLM is no more responsible for your psychosis, diagnosable or otherwise, than the calculator or train are. Your psychosis is one of your own choosing. **The path forward through the psychosis that is partisanship, group-think, lazy heuristics, and avoidance of complexity is just that:** ***through it*****.** Push through the partisanship, the group-think, the complexity. As Derek Thompson [said](https://x.com/DKThomp/status/1947107825265565981), "Writing is not the second thing that happens after thinking. **[Anyone] who outsources their writing to LLMs will find their screens full of words and their minds emptied of thought.**"

Ezra Klein makes the [same point](https://x.com/david_perell/status/1927527749947736112) about reading. Reading isn't the act of uploading knowledge and information into your brain:
...
Reading complex texts [is](https://www.nytimes.com/2025/07/28/opinion/smartphones-literacy-inequality-democracy.html?unlocked_article_code=1.aE8.GC3o.9Vv_4PzVBhhu&smid=nytcore-ios-share&referringSource=articleShare) "literally mind-altering. It rewires our brains, increasing vocabulary, shifting brain activity toward the analytic [left hemisphere](https://www.nytimes.com/2022/11/22/opinion/ezra-klein-podcast-maryanne-wolf.html?showTranscript=1) and honing our capacity for concentration, linear reasoning and deep thought. The presence of these traits at scale contributed to the emergence of free speech, modern science and liberal democracy, among other things." The same is true of writing about complex topics. We text and tweet relentlessly, but do we write complex, multi-faceted explorations of ideas that shatter our sense of self in pursuit of something better?

Henrik Karlsson [says it](https://www.henrikkarlsson.xyz/p/writing-to-think) another way: "**Seeing your ideas crumble can be a frustrating experience, but it is the point if you are writing to think**. You want it to break. It is in the cracks the light shines in."

...
The same is painfully true in venture capital. [I've written before](https://investing1012dot0.substack.com/p/the-bubble-brains-of-venture-capital?utm_source=publication-search) about the Bubble Brains in venture. But the thing I failed to emphasize was that sometimes we think the Bubble Brains are just the masses. The dummies. The most programmable. **But in reality, people in positions of power and influence are just as likely to be Bubble Brains because their financial incentives are the driving force for them.**
...
> *"Open-source models have the illusion of being free. But developers bear the inference costs, which are [often more expensive](https://www.theinformation.com/articles/metas-free-ai-isnt-cheap-to-use-companies-say?rc=cbaiyc) than comparable LLM API calls: either pay a middleman to manage GPUs and host models, or pay the direct costs of GPU depreciation, electricity, and downtime."*
...
> *"AI is a technology of hegemony. Even though open-source models are lagging behind the frontier, we shouldn’t [export our technological secrets to the world for free](https://www.cnbc.com/2024/03/31/in-ai-race-with-us-china-is-behind-on-a-key-weapon-its-own-openai.html). We’ve already recognized the national security risk in other parts of the supply chain via export bans in [lithography](https://www.cnbc.com/2024/01/02/asml-blocked-from-exporting-some-critical-chipmaking-tools-to-china.html#:~:text=Semiconductor%20equipment%20maker%20ASML%20was,revoked%20by%20the%20Dutch%20government.%E2%80%9D) and [semiconductors](https://www.cnbc.com/2023/10/17/us-bans-export-of-more-ai-chips-including-nvidia-h800-to-china.html). When open-source model builders release the model weights, they arm our military adversaries and economic competitors. **If I were the CCP or a terrorist group, I’d be generously funding the open-source AI campaign**."*

And there's certainly credence to this. There have been countless instances of IP theft where China has sought to steal American secrets to expand their own technological capabilities. The Soviets built their first nuclear weapon because [Klaus Fuchs](https://ahf.nuclearmuseum.org/ahf/profile/klaus-fuchs/#:~:text=Manhattan%20Project%20VeteranScientistSpy,secrets%20to%20the%20Soviet%20Union.) stole American secrets. For most of recent technological history, America innovates and other people steal. Making any AI model readily available online puts it right into the hands of nations that are clearly not on our team.

# Saying The Quiet Part Out Loud

[Cunningham's Law](https://en.wikipedia.org/wiki/Ward_Cunningham#%22Cunningham's_Law%22) states that the best way to get the right answer on the internet is to post the wrong answer. Similarly, **the best way to people to demonstrate their world view on the internet isn't to ask them "what do you think?" It's to post an article like John's and let them draw their own battle lines**.
...
Now, here's an important nuance. a16z is actually also an [investor](https://techcrunch.com/2023/04/28/openai-funding-valuation-chatgpt/?guccounter=1) in OpenAI, though I can't tell how much. Certainly not a core position, like OpenAI is for Khosla. However, a16z IS a meaningful investor in Databricks, Mistral, Eleven Labs, Replicate, and Character AI. All of whom benefit from AI being more open-source.

The argument went back and forth a few days ago. John [pointed out](https://x.com/absoluttig/status/1793040365622043030) that a16z simultaneously believes the US has to stop China from dominating in AI, but that open-source models should proliferate freely (including across Chinese borders).

Martin's [response](https://x.com/martin_casado/status/1793041023406408127)? Yes and Yes. He claimed those positions aren't inconsistent.
...
My sense is the scale tipping is going to get worse before it gets better (if it ever does). Around the same time as the John vs. Martin debate was boiling out, it was transposed on a similar, but different, conversation about [SB 1047](https://twitter.com/search?q=sb%201047&src=typed_query). This is a law that was recently passed in California, [which](https://www.wate.com/business/press-releases/ein-presswire/714330132/california-senate-bill-sb-1047-another-stifling-blow-to-silicon-valley-ai-startups/) "aims to impose rigorous safety and regulatory measures on the development of large-scale artificial intelligence (AI) systems."

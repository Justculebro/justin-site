---
title: "The Rise of The Cash Man"
date: 2022-08-18
tags: ["investing"]
...
![Illustration from The Rise of The Cash Man](/images/the-rise-of-the-cash-man-f0d4f489.png)
...
In case you have no idea what I'm talking about (and if so, bless your soul) [Adam Neumann raised $350M from a16z](https://a16z.com/2022/08/15/investing-in-flow/) at "over a billion dollar valuation" for his new residential real estate company [Flow](https://www.flow.life/). And all of this is not just pre-launch, but "before it even commences operations." This also happens to be a16z's largest single check.
...
Everyone should read Mandela’s thread. A lot of people rightfully pointed out that in a world where 93%+ of venture dollars go to white men it can feel like a "slap to the face" to those underfunded groups when someone like Adam, who lit $20B on fire, gets a second go at it at such a scale. Does that actually feel like an appropriate allocation of capital?

## "This is just going to make the housing shortage worse."

[$60B of real estate](https://www.nytimes.com/2020/03/04/magazine/wall-street-landlords.html) has gotten snapped up by big PE firms turning everyday people into "perpetual renters." They're pitching Flow as a salve for the housing crisis, but that feels like a stretch. Neumann's existing real estate holdings [aren't exactly affordable housing](https://www.vox.com/recode/2022/8/17/23309756/wework-adam-neumann-flow-andreessen-venture-capital):
...
This was my least favorite take. Trying to brush aside WeWorks implosion as "so it didn't work out," is a disservice to the colossal Greek tragedy that it is. They don't make [TV dramas](https://en.wikipedia.org/wiki/WeCrashed) about casual startup wind downs. A better framework for evaluating what WeWork was is through the lens of their economic engine.
...
So... what is Flow? What is Neumann pitching? [Here's how a16z puts it:](https://a16z.com/2022/08/15/investing-in-flow/)
...
[A less wordy way](https://www.vox.com/recode/2022/8/17/23309756/wework-adam-neumann-flow-andreessen-venture-capital) of summarizing what is likely getting pitched as the vision for Flow?
...
[According to the New York Times](https://www.nytimes.com/2022/08/15/business/dealbook/adam-neumann-flow-new-company-wework-real-estate.html), "Neumann has purchased more than 3,000 apartment units in Miami, Fort Lauderdale, Atlanta and Nashville. **Flow will operate the properties Neumann has bought** and also offer its services to new developments and other third parties."

That's about the only tangible information we know about Flow. That portfolio of Neumann's properties alone [is worth nearly $1B.](https://www.esquire.com/uk/latest-news/a40917085/what-is-flow-wework-ceo-adam-neumanns-new-company/) In the words of another anonymous twitter account, "I bet Andreessen got some protection or equity through his owned assets." As a result of that kind of possible asset-backed equity arrangement **you can start to see Flow building up its own property portfolio over time.**

What's ironic about this "assets owned by Neumann but managed by his company" dynamic is its exactly one of the things that partially led to WeWork's implosion. When they filed the S-1 we found out things like [Adam Neumann trademarked "The We Company"](https://www.businessinsider.com/wework-ceo-gives-back-millions-from-we-trademark-after-criticism-2019-9) and then had the company pay him $6M for the privilege of using it.

So why wait for the S-1? Be up-front about the conflict of interest.

***How do we work this into our model?*** As anxious as a balance sheet makes most VCs the idea of owning assets can be reassuring here. Worst case scenario you're not just [underwater on a ton of leases](https://www.wsj.com/articles/wework-skips-rent-payments-as-coronavirus-hits-revenue-11586379714) (ala WeWork). That's assuming you can build any equity in those assets...
...
![Quote card from Property Management Services section](/images/the-rise-of-the-cash-man-97bd04e9.png)
...
Say what you will about Adam Neumann, but he loves his amenities. The exorbitant spending at WeWork, on everything from a wave pool to endless kombucha, is still haunting the company in the public markets as they try to be as creative as possible in [limiting operating expenses](https://seekingalpha.com/article/4501206-wework-inc-still-struggling-with-expenditures-limiting-growth).

[In 2016](https://www.esquire.com/uk/latest-news/a40917085/what-is-flow-wework-ceo-adam-neumanns-new-company/) when describing WeLive he painted the picture of the living experience:
...
As far as I can tell this feels just as descriptive of what he's trying to create with Flow, "[creating a branded product with consistent service and community features.](https://www.nytimes.com/2022/08/15/business/dealbook/adam-neumann-flow-new-company-wework-real-estate.html)"
...
Most of the time a tech-enabled business that pitches their use of "cutting edge technology" is often (1) a better UI, and (2) collecting user data. Yet another page out of WeWork's ancillary attempts at a business model, [they touted a data-driven advantage](https://www.ft.com/content/6a823be6-2dcf-11e8-9b4b-bc4b9f08f381). For the most part that data primarily surfaced insights like "people like sitting by windows."

***How do we work this into our model?*** Tenant data can extend all the way from rental applications to living preferences and beyond. Imagine if every aspect of your living experience was monetizable. Any amenity you identify from "tenant data" can immediately be serviced by the highest bidder.

## And Then Some

[Crypto wallet](https://www.forbes.com/sites/davidjeans/2022/08/17/adam-neumanns-flow-a16z-crypto/?sh=4d3034f23a28)? Rent-to-own? Yes, and more. There are plenty of ancillary things that, if they work, can be a meaningful part of the company's future revenue profile.

Some of these "other things that could be meaningful" remind me of Neumann's [early pitches of WeLive](https://www.businessinsider.com/weworks-bets-on-welive-2015-10) as a meaningful part of WeWork's business. In 2015 when WeWork was worth $10B (it's worth $4B now) Neumann expected WeLive to generate over $600M of revenue by 2018 (narrator: "it didn't.")
...
![Tweet referenced in Step Two: The Comps section](/images/the-rise-of-the-cash-man-d5e3fdf6.png)
...
![Chart illustrating step three: the potential](/images/the-rise-of-the-cash-man-31c9a1fa.png)
...
![Chart illustrating step three: the potential](/images/the-rise-of-the-cash-man-3b700d94.png)
...
[Software is eating the world](https://a16z.com/2011/08/20/why-software-is-eating-the-world/). But every once in a while some of the people cooking it feel like a millennial hipster who googled "ancient chinese recipe" and are doing their best with what they have in their Brooklyn apartment. And somehow Doritos made it into the meal.

Instead? We could do a better job of understanding the physical world we want to impact before diving in with a “revolutionary” solution. When I look at the “tech-enabled” businesses tackling the real world there are definitely some phenomenal and [exciting](https://twitter.com/typesfast) solutions.
...
*\*Plenty of nuance in WeWork's balance sheet but the TLDR isn't pretty.*
